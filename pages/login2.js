    ...
    <div className="bg-[#262932] text-[#919393] h-screen">
      ...
      <main>
        ...
        <form action="" className="flex flex-col max-w-[250px] md:max-w-[350px] mx-auto md:fixed md:top-[50%] md:translate-y-[-50%] md:left-[50%] md:translate-x-[-50%] ">
          <h1 className="text-2xl my-10 text-white font-[800] ">Log in</h1>

          <div className="flex items-center gap-2 border-b border-[#ffa600] pb-2">
            <div className=""><BsPhone size="20px" /></div>
            <input type="number" name="number" id="number" placeholder="Enter Mobile Number" className="border-none outline-none bg-transparent" />
          </div>
          ...
          <button type="submit" className="bg-black text-white py-4 mt-5">Login</button>
          <div className="mt-4">
            First time here? <Link href="/signup"><a className="text-[#ffa600]">Sign up.</a></Link>
          </div>
        </form>
